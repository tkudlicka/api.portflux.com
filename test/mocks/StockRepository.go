...
func (_m *StockRepository) Create(ctx context.Context, entity interface{}) (string, error) {
...
func (_m *StockRepository) CreateMany(ctx context.Context, entities []interface{}) ([]string, error) {
...
func (_m *StockRepository) Delete(ctx context.Context, ID string) error {
...
func (_m *StockRepository) Get(ctx context.Context, filter map[string]interface{}, skip *int, take *int) ([]interface{}, error) {
...
func (_m *StockRepository) GetByID(ctx context.Context, ID string) (interface{}, error) {
	ret := _m.Called(ctx, ID)
...
func (_m *StockRepository) Update(ctx context.Context, ID string, entity interface{}) error {
