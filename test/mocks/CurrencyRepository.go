...
func (_m *CurrencyRepository) Create(ctx context.Context, entity interface{}) (string, error) {
...
func (_m *CurrencyRepository) CreateMany(ctx context.Context, entities []interface{}) ([]string, error) {
...
func (_m *CurrencyRepository) Delete(ctx context.Context, ID string) error {
...
func (_m *CurrencyRepository) Get(ctx context.Context, filter map[string]interface{}, skip *int, take *int) ([]interface{}, error) {
...
func (_m *CurrencyRepository) GetByID(ctx context.Context, ID string) (interface{}, error) {
	ret := _m.Called(ctx, ID)
...
func (_m *CurrencyRepository) Update(ctx context.Context, ID string, entity interface{}) error {
