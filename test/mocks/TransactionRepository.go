...
func (_m *TransactionRepository) Create(ctx context.Context, entity interface{}) (string, error) {
...
func (_m *TransactionRepository) CreateMany(ctx context.Context, entities []interface{}) ([]string, error) {
...
func (_m *TransactionRepository) Delete(ctx context.Context, ID string) error {
...
func (_m *TransactionRepository) Get(ctx context.Context, filter map[string]interface{}, skip *int, take *int) ([]interface{}, error) {
...
func (_m *TransactionRepository) GetByID(ctx context.Context, ID string) (interface{}, error) {
	ret := _m.Called(ctx, ID)
...
func (_m *TransactionRepository) Update(ctx context.Context, ID string, entity interface{}) error {
