...
func (_m *StockService) Create(ctx context.Context, user models.CreateUserReq) (models.CreationResp, error) {
...
func (_m *StockService) CreateMany(ctx context.Context, users []models.CreateUserReq) (models.MultiCreationResp, error) {
...
func (_m *StockService) Delete(ctx context.Context, ID string) error {
...
func (_m *StockService) GetAll(ctx context.Context) ([]models.UserResp, error) {
	ret := _m.Called(ctx)
...
func (_m *StockService) GetByID(ctx context.Context, ID string) (models.UserResp, error) {
	ret := _m.Called(ctx, ID)
...
func (_m *StockService) Update(ctx context.Context, ID string, user models.UpdateUserReq) error {
