...
func (_m *PortfolioService) Create(ctx context.Context, user models.CreateUserReq) (models.CreationResp, error) {
...
func (_m *PortfolioService) CreateMany(ctx context.Context, users []models.CreateUserReq) (models.MultiCreationResp, error) {
...
func (_m *PortfolioService) Delete(ctx context.Context, ID string) error {
...
func (_m *PortfolioService) GetAll(ctx context.Context) ([]models.UserResp, error) {
	ret := _m.Called(ctx)
...
func (_m *PortfolioService) GetByID(ctx context.Context, ID string) (models.UserResp, error) {
	ret := _m.Called(ctx, ID)
...
func (_m *PortfolioService) Update(ctx context.Context, ID string, user models.UpdateUserReq) error {
