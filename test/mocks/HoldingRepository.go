...
func (_m *HoldingRepository) Create(ctx context.Context, entity interface{}) (string, error) {
...
func (_m *HoldingRepository) CreateMany(ctx context.Context, entities []interface{}) ([]string, error) {
...
func (_m *HoldingRepository) Delete(ctx context.Context, ID string) error {
...
func (_m *HoldingRepository) Get(ctx context.Context, filter map[string]interface{}, skip *int, take *int) ([]interface{}, error) {
...
func (_m *HoldingRepository) GetByID(ctx context.Context, ID string) (interface{}, error) {
	ret := _m.Called(ctx, ID)
...
func (_m *HoldingRepository) Update(ctx context.Context, ID string, entity interface{}) error {
