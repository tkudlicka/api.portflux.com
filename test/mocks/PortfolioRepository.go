...
func (_m *PortfolioRepository) Create(ctx context.Context, entity interface{}) (string, error) {
...
func (_m *PortfolioRepository) CreateMany(ctx context.Context, entities []interface{}) ([]string, error) {
...
func (_m *PortfolioRepository) Get(ctx context.Context, filter map[string]interface{}, skip *int, take *int) ([]interface{}, error) {
...
func (_m *PortfolioRepository) GetByID(ctx context.Context, ID string) (interface{}, error) {
	ret := _m.Called(ctx, ID)
...
func (_m *PortfolioRepository) Update(ctx context.Context, ID string, entity interface{}) error {
