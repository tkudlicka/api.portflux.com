...
func (_m *CurrencyService) Create(ctx context.Context, user models.CreateUserReq) (models.CreationResp, error) {
...
func (_m *CurrencyService) CreateMany(ctx context.Context, users []models.CreateUserReq) (models.MultiCreationResp, error) {
...
func (_m *CurrencyService) Delete(ctx context.Context, ID string) error {
...
func (_m *CurrencyService) GetAll(ctx context.Context) ([]models.UserResp, error) {
	ret := _m.Called(ctx)
...
func (_m *CurrencyService) GetByID(ctx context.Context, ID string) (models.UserResp, error) {
	ret := _m.Called(ctx, ID)
...
func (_m *CurrencyService) GetBySymbol(ctx context.Context, symbol string) (models.UserResp, error) {
...
func (_m *CurrencyService) Update(ctx context.Context, ID string, user models.UpdateUserReq) error {
