...
// BrokerRepository is an autogenerated mock type for the BrokerRepository type
type BrokerRepository struct {
	mock.Mock
}

// Create provides a mock function with given fields: ctx, entity
func (_m *BrokerRepository) Create(ctx context.Context, entity interface{}) (string, error) {
...
func (_m *BrokerRepository) CreateMany(ctx context.Context, entities []interface{}) ([]string, error) {
...
func (_m *BrokerRepository) Delete(ctx context.Context, ID string) error {
...
func (_m *BrokerRepository) Get(ctx context.Context, filter map[string]interface{}, skip *int, take *int) ([]interface{}, error) {
...
func (_m *BrokerRepository) GetByID(ctx context.Context, ID string) (interface{}, error) {
	ret := _m.Called(ctx, ID)
...
func (_m *BrokerRepository) GetBySlug(ctx context.Context, Slug string) (interface{}, error) {
...
func (_m *BrokerRepository) Update(ctx context.Context, ID string, entity interface{}) error {
...
// NewBrokerRepository creates a new instance of BrokerRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewBrokerRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *BrokerRepository {
